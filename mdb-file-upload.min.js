...
(function(e, i) {
    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            this.element = i, this.input = e(this.element), this.wrapper = null, this.preview = null, this.filenameWrapper = null, this.settings = e.extend(!0, s, t, this.input.data()), this.errorsEvent = e.Event("file_upload.errors"), this.isDisabled = !1, this.isInit = !1, this.file = {
                object: null,
                name: null,
                size: null,
                width: null,
            ...
            this.readFile = this.settings.onFileUpload;
        }
    }
    var t = "file_upload";
    return i.prototype.onChange = function() {
        ...
        if (i.files && i.files[0]) {
            ...
            this.clearErrors(), this.showLoader(), this.setFileInformations(r), this.errorsEvent.errors = [], this.checkFileSize(), this.isFileExtensionAllowed(), this.isImage() && this.file.size < this.sizeToByte(this.settings.maxFileSizePreview) ? (this.input.on("file_upload.fileReady", this.onFileReady), t.readAsDataURL(r), t.onload = function(e) {
